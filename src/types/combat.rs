...
pub struct IronDome{ pub position:Vec3, pub cooldown:f32, pub angle:f32 }
...
pub struct AirEvent{ pub active:bool, pub timer:f32, pub fly_time:f32, pub bomber_pos:Vec3, pub jet1_pos:Vec3, pub jet2_pos:Vec3, pub bullets:Vec<BulletParticle>, pub bomber_hp:u32 }
pub struct ThiefChild{ pub position:Vec3, pub target_cell:Option<(usize,usize)>, pub speed:f32, pub fleeing:bool, pub alive:bool, pub facing:f32, pub anim_timer:f32, pub harvesting_timer:f32, pub hp:f32, pub max_hp:f32, pub has_stolen:bool, pub flee_target:Vec3, pub steal_count:u8, pub spawn_house_idx:Option<usize> }
